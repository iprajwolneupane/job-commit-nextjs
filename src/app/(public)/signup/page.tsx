...
type RegisterErrorResponse = {
    message?: string
    errors?: Partial<Record<keyof SignupFormValues, Array<string>>>
}
...
function SignupPage() {
    ...
    const registerMutation = useMutation({
        ...
        onError: (error: AxiosError<RegisterErrorResponse>) => {
            handleError<RegisterErrorResponse>(error)
        },
    })
            ...
            <section className="w-full max-w-md">
                ...
                <div className="relative overflow-hidden rounded-2xl bg-card p-6 text-card-foreground shadow-sm sm:p-8">
                    <div className="mb-6 space-y-2">
                        <p className="text-sm font-semibold text-primary">Start tracking</p>
                        <h1 className="text-2xl font-bold text-foreground">
                            Create your JobCommit account
                        </h1>
                        <p className="text-sm leading-6 text-muted-foreground">
                            Organize applications and follow-ups momentum from day one.
                        </p>
                    </div>
